...
export default function SectionTwo() {
  ...
  return (
    ...
    maxWidth="lg" sx={{  height:'100%',py:10,
    // minHeight:'100vh',
      display:'flex', justifyContent:'center', alignItems:'center', flexDirection:'column' }}>
            ...
            <Grid container spacing={{ xs: 3, md: 6 }}>
              <Grid item xs={12} md={4}>
                <Box    data-aos="zoom-in" sx={{ textAlign: 'center', p: { xs: 3, md: 5 }, borderRadius: 3, transition: 'transform .2s ease, box-shadow .2s ease', willChange: 'transform', '&:hover': { boxShadow: '0 8px 24px rgba(17,25,39,0.12)', transform: 'translateY(-2px)' } }} data-aos="zoom-in" data-aos-delay="0">
              ...
              <Grid item xs={12} md={4}>
                ...
                <Box    data-aos="zoom-in"  sx={{ textAlign: 'center', p: { xs: 3, md: 5 }, borderRadius: 3, transition: 'transform .2s ease, box-shadow .2s ease', willChange: 'transform', '&:hover': { boxShadow: '0 8px 24px rgba(17,25,39,0.12)', transform: 'translateY(-2px)' } }} data-aos="zoom-in" data-aos-delay="150">
                  {/* <Box sx={{ display: 'inline-flex', p: 3, borderRadius: '50%', backgroundColor: 'rgba(173,47,145,0.08)', mb: 2 }}> */}
              ...
              <Grid item xs={12} md={4}>
                <Box    data-aos="zoom-in" sx={{ textAlign: 'center', p: { xs: 3, md: 5 }, borderRadius: 3, transition: 'transform .2s ease, box-shadow .2s ease', willChange: 'transform', '&:hover': { boxShadow: '0 8px 24px rgba(17,25,39,0.12)', transform: 'translateY(-2px)' } }} data-aos="zoom-in" data-aos-delay="300">
                  {/* <Box sx={{ display: 'inline-flex', p: 3, borderRadius: '50%', backgroundColor: 'rgba(173,47,145,0.08)', mb: 2 }}> */}
